      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo yii::app()->user->name?> <span class="caret"></span></a>
              <ul class="dropdown-menu dropdown-menu-left">
                <li><a title="查看或修改个人信息" data-toggle="modal" data-target="#seeUserInfo">个人信息</a></li>
                <li><a title="查看您的登录记录" data-toggle="modal" data-target="#seeUserLoginlog">登录记录</a></li>
              </ul>
            </li>
            <li><a href="<?php echo $this->createUrl('login/logout')?>" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            ...
            <tr>
              <td>上次登录时间: 2016-01-08 15:50:28 , 上次登录IP: <?php echo yii::app()->request->userHostAddress;?></td>
            </tr>
          </tbody>
        </table>
      </div>
