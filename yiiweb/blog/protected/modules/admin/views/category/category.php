        ...
        <div class="col-md-5">
          ...
          ?>
            <div class="form-group">
              ...
              <?php echo $form->textField($categoryModel, 'name', array('id'=>'category-name', 'class'=>'form-control', 'placeholder'=>'在此处输入栏目名称', 'autocomplete'=>'off', 'required'=>'required')) ?>
        ...
        <div class="col-md-7">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php foreach ($categoryInfo as $key => $value) { ?>
                <tr>
                  <td><?php echo $value->cid;?></td>
                  <td><?php echo $value->name;?></td>
                  <td><a href="<?php echo $this->createUrl('update_category', array('id'=>$value->cid))?>">修改</a> 
                    <a href="<?php echo $this->createUrl('del', array('id'=>$value->cid))?>">删除</a></td>
                </tr>
              <?php } ?>
              </tbody>
            </table>
