...
<link rel="stylesheet" type="text/css" href="<?php echo yii::app()->request->baseUrl ?>/assets/admin/css/font-awesome.min.css">
...
<section class="container-fluid">
  ...
  <div class="row">
      ...
      <ul class="nav nav-sidebar">
        <li class="active"><a href="<?php echo $this->createUrl('default/main');?>">报告</a></li>
      </ul>
      <ul class="nav nav-sidebar">
        <li><a href="<?php echo $this->createUrl('article/article');?>">文章</a></li>
        <li><a href="notice.html">公告</a></li>
        <li><a href="<?php echo $this->createUrl('comment/comment');?>">评论</a></li>
        <li><a data-toggle="tooltip" data-placement="bottom" title="网站暂无留言功能">留言</a></li>
      </ul>
      <ul class="nav nav-sidebar">
        <li><a href="<?php echo $this->createUrl('category/category');?>">栏目</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <!-- <form action="/Article/add" method="post" class="add-article-form"> -->
          <?php $form = $this->beginWidget('CActiveForm',array('htmlOptions' => array("class"=>"add-article-form", 'enctype'=>'multipart/form-data')));?>
          <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <?php echo $form->textField($articleModel, 'title', array('id'=>'article-title', 'class'=>'form-control', 'placeholder'=>'在此处输入标题', 'required'=>'required', 'autocomplete'=>'off'))?>
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <!-- <textarea  name="content" autocomplete="off" id="article-content"></textarea> -->
              <?php echo $form->textArea($articleModel, 'content', array('id'=>'article-content', 'autocomplete'=>'off'));?>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>关键字</span></h2>
              <div class="add-article-box-content">
              	<!-- <input type="text" class="form-control" placeholder="请输入关键字" name="keywords" autocomplete="off"> -->
                <?php echo $form->textField($articleModel, 'keywords', array('class'=>'form-control', 'placeholder'=>'请输入关键字', 'autocomplete'=>'off')) ?>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <?php echo $form->textArea($articleModel, 'describe', array('class'=>'form-control', 'autocomplete'=>'off')) ;?>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                   <?php echo $form->dropDownList($articleModel, 'pid', $cateArr, array('class'=>'form-control'));?>
              </div>
            </div>
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <!-- <input type="text" class="form-control" placeholder="输入新标签" name="tags" autocomplete="off"> -->
                 <?php echo $form->textField($articleModel, 'tags', array('class'=>'form-control', 'placeholder'=>'输入新标签', 'autocomplete'=>'off')) ?>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <?php echo $form->textField($articleModel, 'titlepic', array('id'=>'pictureUpload', 'class'=>'form-control', 'placeholder'=>'点击按钮选择图片', 'autocomplete'=>'off')) ?>
              </div>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="<?php echo yii::app()->request->baseUrl ?>/assets/admin/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="<?php echo yii::app()->request->baseUrl ?>/assets/admin/images/baoman/baoman_01.gif" alt="深思熟虑" />
...
<script src="<?php echo yii::app()->request->baseUrl ?>/assets/admin/js/admin-scripts.js"></script>
<script src="<?php echo yii::app()->request->baseUrl ?>/assets/admin/lib/ueditor/ueditor.config.js"></script> 
<script src="<?php echo yii::app()->request->baseUrl ?>/assets/admin/lib/ueditor/ueditor.all.min.js"> </script> 
<script src="<?php echo yii::app()->request->baseUrl ?>/assets/admin/lib/ueditor/lang/zh-cn/zh-cn.js"></script>  
