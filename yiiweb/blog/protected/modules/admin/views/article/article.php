  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="<?php echo $this->createUrl('article/add_article');?>">增加文章</a></li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              <?php foreach ($articleInfo as $key => $value) {?>
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="" /></td>
                <td class="article-title"><?php echo $value->title ?></td>
                <?php 
                  foreach ($categoryInfo as $key => $v) {
                    if($value->pid == $v->cid){  
                ?>
                ...
                ?>
                <td class="hidden-sm"><?php echo $value->tags ?></td>
                <td class="hidden-sm">0</td>
                <td><?php echo date("Y-m-d",$value->addtime) ?></td>
                <td><a href="<?php echo $this->createUrl('update_article', array('id'=>$value->id)); ?>">修改</a> 
                    <a href="<?php echo $this->createUrl('del', array('id'=>$value->id)); ?>" rel="6">删除</a></td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
