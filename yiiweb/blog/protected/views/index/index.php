<!--header-->
        <div id="slideBox" class="slideBox">
            <div class="bd">
                <ul>
                    <li>
                        <a class="pic" href="#"><img src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/banner.png" /></a>
                    </li>
                    <li>
                        <a class="pic" href="#"><img src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/banner.png" /></a>
                    </li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="column_figure">
                            <img src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic01.jpg"/>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center">
                        <img class="adv_img img-circle" src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic03.png"/>
                        <p class="adv_tit">美观性</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center">
                        <img class="adv_img img-circle" src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic04.png"/>
                        <p class="adv_tit">耐磨性</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center">
                        <img class="adv_img img-circle" src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic05.png"/>
                        <p class="adv_tit">抗菌性</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 text-center">
                        <img class="adv_img img-circle" src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic06.png"/>
                    ...
                    <ul class="product_list">
                        <li class="pro_item col-lg-3 col-md-3 col-sm-3 col-xs-6">
                            <a class="pro_pic" href="#">
                                <img src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic02.jpg"/>
                            </a>
                        ...
                        <div id="news_slide" class="news_slide_box">
                            <div class="bd">
                                <ul>
                                    <li>
                                        <a class="pic" href="#">
                                            <img src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic07.jpg" />
                                            <span class="title">
                                                新闻标题
                                            </span>
                                        </a>
                        ...
                        <ul class="news_list">
                            <li>
                                <div class="news_pic col-lg-3 col-md-3 col-sm-4 col-xs-12">									
                                    <a href="#" class="">
                                        <img src="<?php echo yii::app()->request->baseUrl ?>/assets/index/upload/pic08.jpg"/>
                                    </a>
                                </div>
        ...
        <!--footer-->
        <script type="text/javascript" src="<?php echo yii::app()->request->baseUrl ?>/assets/index/js/jquery-1.11.3.js" ></script>
        <script type="text/javascript" src="<?php echo yii::app()->request->baseUrl ?>/assets/index/js/main.js" ></script>
        <script type="text/javascript" src="<?php echo yii::app()->request->baseUrl ?>/assets/index/js/TouchSlide.1.1.js" ></script>
        <script>
            TouchSlide({
                slideCell: "#slideBox",
                titCell: ".hd li",
